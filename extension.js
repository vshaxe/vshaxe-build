...
var vshaxe_Target = $hxEnums["vshaxe.Target"] = { __ename__:true,__constructs__:null
...
vshaxeBuild_cli_CliTools.prototype = {
	...
	,inDir: function(dir,f) {
		var oldCwd = haxe_io_Path.addTrailingSlash(process.cwd());
		this.setCwd(dir);
		f();
		this.setCwd(oldCwd);
	}
...
vshaxeBuild_extension_TaskProvider.prototype = {
	...
	,createTask: function(name,target,debug,additionalArgs) {
		...
		var task = new vscode_Task(definition,vscode_TaskScope.Workspace,name,"vshaxe-build",execution,this.vshaxe.problemMatchers.slice());
