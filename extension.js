// Generated by Haxe 4.0.0-rc.1+d2aba58d5
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(s.hasNext()) {
			...
			if(!(__map_reserved[s1] != null ? assigned.getReserved(s1) : assigned.h[s1])) {
				if(lastPos == null) {
					lastPos = this.putils.convertPosition(new hxjsonast_Position(pos.file,pos.max - 1,pos.max - 1));
				}
...
JsonParser_$25.prototype = {
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			case "path":
				try {
					var tmp = new JsonParser_$10(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					this.value["path"] = tmp;
					if(__map_reserved["path"] != null) {
						assigned.setReserved("path",true);
					} else {
	...
	,getAuto: function() {
		return { path : new JsonParser_$10([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), target : new JsonParser_$26([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
};
...
JsonParser_$26.prototype = {
	...
	,loadJsonString: function(s,pos,variable) {
		switch(s) {
		case "as3":case "cpp":case "cppia":case "hl":case "interp":case "java":case "js":case "lua":case "neko":case "php":case "python":case "swf":
			this.value = s;
			break;
		default:
			this.value = "swf";
