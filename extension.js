...
var $estr = function() { return js_Boot.__string_rec(this,''); },$hxEnums = {};
...
JsonParser_$12.prototype = {
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			case "afterBuildCommands":
				try {
					var tmp = new JsonParser_$14(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					if(tmp == null) {
			...
			case "args":
				try {
					var tmp1 = new JsonParser_$20(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					if(tmp1 == null) {
			...
			case "beforeBuildCommands":
				try {
					var tmp2 = new JsonParser_$14(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					if(tmp2 == null) {
			...
			case "display":
				try {
					var tmp5 = new JsonParser_$31(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					if(tmp5 == null) {
			...
			case "installCommands":
				try {
					var tmp7 = new JsonParser_$14(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					if(tmp7 == null) {
			...
			case "targetDependencies":
				try {
					var tmp9 = new JsonParser_$17(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					if(tmp9 == null) {
	...
	,getAuto: function() {
		var _g = hxjsonast_JsonValue.JNull;
		var tmp = new JsonParser_$14([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g,new hxjsonast_Position("",0,1)));
		var _g1 = hxjsonast_JsonValue.JNull;
		var tmp1 = new JsonParser_$14([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g1,new hxjsonast_Position("",0,1)));
		var _g2 = hxjsonast_JsonValue.JNull;
		...
		var tmp4 = new JsonParser_$14([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g4,new hxjsonast_Position("",0,1)));
		...
		var tmp6 = new JsonParser_$17([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g6,new hxjsonast_Position("",0,1)));
...
JsonParser_$14.prototype = {
	...
	,loadJsonArray: function(a,pos,variable) {
		...
		while(_g1 < a.length) {
			...
			var tmp;
			try {
				tmp = new JsonParser_$15(this.errors,this.putils,json2object_ErrorType.THROW).loadJson(j,variable);
			} catch( _ ) {
				var _1 = (_ instanceof js__$Boot_HaxeError) ? _.val : _;
				if(typeof(_1) == "string") {
					var _2 = _1;
	...
	,getAuto: function() {
		var _g = hxjsonast_JsonValue.JNull;
		return new JsonParser_$14([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g,new hxjsonast_Position("",0,1)));
	}
};
...
JsonParser_$17.prototype = {
	...
	,getAuto: function() {
		var _g = hxjsonast_JsonValue.JNull;
		return new JsonParser_$17([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g,new hxjsonast_Position("",0,1)));
	}
};
...
JsonParser_$20.prototype = {
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		if(__map_reserved["times"] != null) {
			assigned.setReserved("times",true);
		} else {
			assigned.h["times"] = true;
		}
		...
		while(_g < o.length) {
			...
			case "classPaths":
				try {
					var tmp = new JsonParser_$17(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
			...
			case "deadCodeElimination":
				try {
					var tmp1 = new JsonParser_$22(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
			...
			case "defines":
				try {
					var tmp3 = new JsonParser_$17(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
			...
			case "haxelibs":
				try {
					var tmp4 = new JsonParser_$17(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
			...
			case "macros":
				try {
					var tmp5 = new JsonParser_$17(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
			...
			case "output":
				try {
					var tmp8 = new JsonParser_$25(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
			...
			case "times":
				try {
					var tmp10 = new JsonParser_$6(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					this.value["times"] = tmp10;
					if(__map_reserved["times"] != null) {
						assigned.setReserved("times",true);
					} else {
						assigned.h["times"] = true;
			...
			case "workingDirectory":
				try {
					var tmp11 = new JsonParser_$10(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
					if(tmp11 == null) {
						this.value.workingDirectory = null;
					} else {
						this.value.workingDirectory = tmp11;
					}
					if(__map_reserved["workingDirectory"] != null) {
						assigned.setReserved("workingDirectory",true);
					} else {
					...
					var _23 = (_22 instanceof js__$Boot_HaxeError) ? _22.val : _22;
				}
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
	...
	,getAuto: function() {
		...
		var _g11 = hxjsonast_JsonValue.JNull;
		return { classPaths : new JsonParser_$17([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g,new hxjsonast_Position("",0,1))), deadCodeElimination : new JsonParser_$22([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g1,new hxjsonast_Position("",0,1))), debug : new JsonParser_$6([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g2,new hxjsonast_Position("",0,1))), defines : new JsonParser_$17([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g3,new hxjsonast_Position("",0,1))), haxelibs : new JsonParser_$17([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g4,new hxjsonast_Position("",0,1))), macros : new JsonParser_$17([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g5,new hxjsonast_Position("",0,1))), main : new JsonParser_$10([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g6,new hxjsonast_Position("",0,1))), noInline : new JsonParser_$6([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g7,new hxjsonast_Position("",0,1))), output : new JsonParser_$25([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g8,new hxjsonast_Position("",0,1))), packageName : new JsonParser_$10([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g9,new hxjsonast_Position("",0,1))), times : new JsonParser_$6([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g10,new hxjsonast_Position("",0,1))), workingDirectory : new JsonParser_$10([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g11,new hxjsonast_Position("",0,1)))};
	}
};
...
JsonParser_$22.prototype = {
	...
	,getAuto: function() {
		var _g = hxjsonast_JsonValue.JNull;
		return new JsonParser_$22([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g,new hxjsonast_Position("",0,1)));
	}
};
...
JsonParser_$25.prototype = {
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			case "target":
				try {
					var tmp1 = new JsonParser_$26(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
	...
	,getAuto: function() {
		var _g = hxjsonast_JsonValue.JNull;
		var _g1 = hxjsonast_JsonValue.JNull;
		return { path : new JsonParser_$8([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g,new hxjsonast_Position("",0,1))), target : new JsonParser_$26([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g1,new hxjsonast_Position("",0,1)))};
	}
};
...
JsonParser_$26.prototype = {
	...
	,getAuto: function() {
		var _g = hxjsonast_JsonValue.JNull;
		return new JsonParser_$26([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g,new hxjsonast_Position("",0,1)));
	}
};
...
JsonParser_$31.prototype = {
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			case "installCommands":
				try {
					var tmp3 = new JsonParser_$14(this.errors,this.putils,json2object_ErrorType.OBJECTTHROW).loadJson(field.value,field.name);
	...
	,getAuto: function() {
		...
		var tmp1 = new JsonParser_$14([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g1,new hxjsonast_Position("",0,1)));
		var _g2 = hxjsonast_JsonValue.JNull;
		var tmp2 = new JsonParser_$14([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g2,new hxjsonast_Position("",0,1)));
		var _g3 = hxjsonast_JsonValue.JNull;
		var tmp3 = new JsonParser_$17([],this.putils,json2object_ErrorType.NONE).loadJson(new hxjsonast_Json(_g3,new hxjsonast_Position("",0,1)));
...
haxe_ds_Option.Some.__params__ = ["v"];;
haxe_ds_Option.None = {_hx_index:1};
...
$hxEnums["haxe_io_Error"] = haxe_io_Error;
haxe_io_Error.Blocked = {_hx_index:0};
haxe_io_Error.Blocked.toString = $estr;
haxe_io_Error.Blocked.__enum__ = "haxe_io_Error";
haxe_io_Error.Overflow = {_hx_index:1};
haxe_io_Error.Overflow.toString = $estr;
haxe_io_Error.Overflow.__enum__ = "haxe_io_Error";
haxe_io_Error.OutsideBounds = {_hx_index:2};
haxe_io_Error.OutsideBounds.toString = $estr;
haxe_io_Error.OutsideBounds.__enum__ = "haxe_io_Error";
haxe_io_Error.Custom = function(e) { var $x = {_hx_index:3,e:e,__enum__:"haxe_io_Error"}; $x.toString = $estr; return $x; }
haxe_io_Error.Custom.__params__ = ["e"];;
...
$hxEnums["hxjsonast_JsonValue"] = hxjsonast_JsonValue;
hxjsonast_JsonValue.JString = function(s) { var $x = {_hx_index:0,s:s,__enum__:"hxjsonast_JsonValue"}; $x.toString = $estr; return $x; }
hxjsonast_JsonValue.JString.__params__ = ["s"];;
hxjsonast_JsonValue.JNumber = function(s) { var $x = {_hx_index:1,s:s,__enum__:"hxjsonast_JsonValue"}; $x.toString = $estr; return $x; }
hxjsonast_JsonValue.JNumber.__params__ = ["s"];;
hxjsonast_JsonValue.JObject = function(fields) { var $x = {_hx_index:2,fields:fields,__enum__:"hxjsonast_JsonValue"}; $x.toString = $estr; return $x; }
hxjsonast_JsonValue.JObject.__params__ = ["fields"];;
hxjsonast_JsonValue.JArray = function(values) { var $x = {_hx_index:3,values:values,__enum__:"hxjsonast_JsonValue"}; $x.toString = $estr; return $x; }
hxjsonast_JsonValue.JArray.__params__ = ["values"];;
hxjsonast_JsonValue.JBool = function(b) { var $x = {_hx_index:4,b:b,__enum__:"hxjsonast_JsonValue"}; $x.toString = $estr; return $x; }
hxjsonast_JsonValue.JBool.__params__ = ["b"];;
hxjsonast_JsonValue.JNull = {_hx_index:5};
...
$hxEnums["json2object_Error"] = json2object_Error;
json2object_Error.IncorrectType = function(variable,expected,pos) { var $x = {_hx_index:0,variable:variable,expected:expected,pos:pos,__enum__:"json2object_Error"}; $x.toString = $estr; return $x; }
json2object_Error.IncorrectType.__params__ = ["variable","expected","pos"];;
json2object_Error.IncorrectEnumValue = function(value,expected,pos) { var $x = {_hx_index:1,value:value,expected:expected,pos:pos,__enum__:"json2object_Error"}; $x.toString = $estr; return $x; }
json2object_Error.IncorrectEnumValue.__params__ = ["value","expected","pos"];;
json2object_Error.InvalidEnumConstructor = function(value,expected,pos) { var $x = {_hx_index:2,value:value,expected:expected,pos:pos,__enum__:"json2object_Error"}; $x.toString = $estr; return $x; }
json2object_Error.InvalidEnumConstructor.__params__ = ["value","expected","pos"];;
json2object_Error.UninitializedVariable = function(variable,pos) { var $x = {_hx_index:3,variable:variable,pos:pos,__enum__:"json2object_Error"}; $x.toString = $estr; return $x; }
json2object_Error.UninitializedVariable.__params__ = ["variable","pos"];;
json2object_Error.UnknownVariable = function(variable,pos) { var $x = {_hx_index:4,variable:variable,pos:pos,__enum__:"json2object_Error"}; $x.toString = $estr; return $x; }
json2object_Error.UnknownVariable.__params__ = ["variable","pos"];;
json2object_Error.ParserError = function(message,pos) { var $x = {_hx_index:5,message:message,pos:pos,__enum__:"json2object_Error"}; $x.toString = $estr; return $x; }
json2object_Error.ParserError.__params__ = ["message","pos"];;
var json2object_ErrorType = { __ename__ : true, __constructs__ : ["NONE","OBJECTTHROW","THROW"] };
$hxEnums["json2object_ErrorType"] = json2object_ErrorType;
json2object_ErrorType.NONE = {_hx_index:0};
json2object_ErrorType.NONE.toString = $estr;
json2object_ErrorType.NONE.__enum__ = "json2object_ErrorType";
json2object_ErrorType.OBJECTTHROW = {_hx_index:1};
json2object_ErrorType.OBJECTTHROW.toString = $estr;
json2object_ErrorType.OBJECTTHROW.__enum__ = "json2object_ErrorType";
json2object_ErrorType.THROW = {_hx_index:2};
...
sys_io_FileSeek.SeekCur = {_hx_index:1};
